...
import { ArrowLeft, Copy, Check, Sparkles, Image as ImageIcon } from "lucide-react";
...
export default function CampaignPage() {
  ...
  async function handleGenerate(e: React.FormEvent) {
    ...
    try {
      ...
      setProvider(enhanceData.provider || "unknown");
      ...
      setImageUrl(objUrl);
      setImageLoaded(false); // will be set true on img.onLoad
      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur">
        <div className="container flex h-16 items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold">Campaign Visual Studio</span>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card>
            <CardContent className="p-6 space-y-6">
              ...
              <div>
                <h2 className="font-semibold text-lg mb-3">2. Articles to Promote</h2>
                ...
                <form onSubmit={handleAddArticle} className="space-y-2 pt-3 border-t border-dashed">
                  <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Add article</p>
                  <Input
          ...
          <Card>
            <CardContent className="p-6 space-y-4">
              <h2 className="font-semibold text-lg">3. Prompt Input</h2>
              <form onSubmit={handleGenerate} className="space-y-3">
                <div className="space-y-1.5">
                  <Label>Rough idea</Label>
                  <Textarea
                    rows={5}
                    placeholder="Example: premium perfume bottle hero shot, dark amber lighting, clean studio background"
                    value={roughPrompt}
                ...
                <Button type="submit" disabled={isGenerating} className="w-full">
                  ...
                  {isGenerating ? "Working…" : "Enhance & Generate"}
                </Button>
              </form>
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Provider: <span className="inline-flex items-center rounded-full bg-muted px-2 py-0.5 text-xs font-semibold">{provider}</span>
                </p>
              </div>

              {enhancedPrompt && (
                <div className="space-y-1.5 pt-2 border-t border-dashed">
                  <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Enhanced prompt</p>
          ...
          <CardContent className="p-6">
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_1.3fr] items-start">
              ...
              <div className="lg:sticky lg:top-20">
                ...
                <p className="text-xs text-muted-foreground mt-2">Tip: use Image blur to create a soft focus editorial look.</p>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-dashed space-y-4">
              <div className="flex items-baseline justify-between gap-4 flex-wrap">
                <h2 className="font-semibold text-lg">5. Social Media Caption</h2>
